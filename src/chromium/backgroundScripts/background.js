...
import { getIsFirefoxInstalled, getIsFirefoxDefault, getIsAutoRedirect } from "../../shared/backgroundScripts/getters.js";
import { initContextMenu, handleContextMenuClick, updateAddCurrentSiteToMySitesContextMenu } from "../../shared/backgroundScripts/contextMenus.js";
import { handleAutoRedirect, refreshDeclarativeNetRequestRules } from "../../shared/backgroundScripts/autoRedirect.js";
import { launchFirefox, checkAndUpdateURLScheme } from "../../shared/backgroundScripts/launchBrowser.js";
import { handleHotkeyPress } from "../../shared/backgroundScripts/hotkeys.js";
